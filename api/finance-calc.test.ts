...
import { fmtAed, fmtAedWhole, isRenewalDue, summarizePayments, rollupBudgets, type PayLite, type BudgetLite } from "./lib/finance-calc";
...
describe("payment summary", () => {
  ...
  const rows: PayLite[] = [
    { amount: 599900, status: "paid", tier: "ascent", createdAt: "2026-08-02T00:00:00Z" },   // this month
    { amount: 99900, status: "paid", tier: "horizon", createdAt: "2026-07-20T00:00:00Z" },   // prior month
    { amount: 599900, status: "refunded", tier: "ascent", createdAt: "2026-08-03T00:00:00Z" },
    { amount: 1199900, status: "pending", tier: "vanguard", createdAt: "2026-08-10T00:00:00Z" },
  ];
