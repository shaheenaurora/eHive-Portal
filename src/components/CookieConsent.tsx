  ...
  return (
    <div
      ...
      style={{
        ...
        border: "1px solid var(--eh-line, #e4ddd0)",
        borderRadius: 14,
        boxShadow: "0 18px 50px rgba(16,29,44,.28)",
    ...
    >
      <p
        ...
        style={{
          margin: 0,
          fontSize: ".86rem",
          color: "var(--eh-ink-3, #33465e)",
          flex: "1 1 260px",
          lineHeight: 1.55,
        }}
      >
        We use essential cookies to run your session, and — only with your
        consent — analytics to improve eHive. You can change this anytime. See
        our{" "}
        <a href="/privacy.html" style={{ color: "var(--eh-gold, #b8862e)" }}>
          Privacy Policy
        </a>
        .
      </p>
